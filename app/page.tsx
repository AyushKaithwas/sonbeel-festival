...
export default function Home() {
  return (
    <div className="flex flex-col h-[100vh]">
      ...
      <div className="flex flex-col w-full items-center py-20 my-10 bg-card">
      ...
      <div className="">
        <div className="h-[20rem] items-center justify-center flex p-24 bg-[url('/images/mid-section-bg.png')] bg-center  bg-fixed bg-no-repeat bg-cover">
          <h1 className="text-white  text-2xl drop-shadow-[0_10px_10px_rgba(0,0,0,0.5)]">
      ...
      <div className="flex flex-col w-full items-center py-20 my-10 gap-20">
